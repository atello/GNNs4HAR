...
def load_data(ds_name, ds_variant, fillnan=None, batch_size=64, threshold=0.2):
    ...
    for key, mtrx in corr_matrices.items():
        ...
        im = plt.imshow(mtrx, cmap=plt.cm.viridis)
        ...
        params = {'font.size': 13,
                  'axes.labelsize': 16, 'xtick.labelsize': 15, 'ytick.labelsize': 15}
        plt.rcParams.update(params)
        plt.savefig(f'./figs/adj_matrices/{ds_name}/{ds_variant}_{lbl_id:02d}_{label}.svg', format="svg"),
